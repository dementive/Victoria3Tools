...
class GameData:
	...
	def __init__(self):
		...
		self.TriggersList = {
			...
			"civil_war_progress": "Compare progress of civil war<br>civil_war_progress > 50<br>Traits: &lt;, &le;, =, !=, &gt;, &ge;<br>Supported Scopes: civil_war",
			"civil_war_progress_gain": "Checks how much progress the civil war is gaining each tick.<br>any_civil_war = { revolution_progress_gain > 0 }<br>Traits: &lt;, &le;, =, !=, &gt;, &ge;<br>Supported Scopes: civil_war",
			...
			"construction_queue_duration": "Compares the very roughly approximated time remaining to finish the queue<br>Traits: &lt;, &le;, =, !=, &gt;, &ge;<br>Supported Scopes: country",
			"construction_queue_government_duration": "Compares the very roughly approximated time remaining to finish the private constructions in the queue<br>Traits: &lt;, &le;, =, !=, &gt;, &ge;<br>Supported Scopes: country",
			...
			"construction_queue_private_duration": "Compares the very roughly approximated time remaining to finish the government constructions in the queue<br>Traits: &lt;, &le;, =, !=, &gt;, &ge;<br>Supported Scopes: country",
			...
			"investment_pool": "Compares the money in the investment pool of a given country<br>investment_pool > 1000<br>Traits: &lt;, &le;, =, !=, &gt;, &ge;<br>Supported Scopes: country",
			...
			"was_formed_from": "Check if a country was formed from a specific definition<br>was_formed_from = <tag><br>Supported Scopes: country",
			...
			"literacy_rate": "Checks if a pop, state or country has a certain amount of literacy<br>literacy = value<br>Traits: &lt;, &le;, =, !=, &gt;, &ge;<br>Supported Scopes: country, state, pop",
