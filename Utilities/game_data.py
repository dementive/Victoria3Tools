...
class GameData:
	...
	def __init__(self):
		...
		self.EffectsList = {
			...
			"annex_as_civil_war": "Annexes a country with all the inheritance effects of a victorious side in a civil war  <br>annex = scope  <br>**Supported Scopes**: country  <br>**Supported Targets**: country",
		...
		self.TriggersList = {
			"active_lens": "Checks if the specified lens is open  <br>active_lens = lensAn interface trigger, can only be used in specific places  <br>**Supported Scopes**: none",
			"active_lens_option": "Checks if the specified lens option is activated  <br>active_lens_option = lens_option_keyAn interface trigger, can only be used in specific places  <br>**Supported Scopes**: none",
			...
			"age": "Compares the character age  <br>age > 20Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: character",
			"aggressive_diplomatic_plays_permitted": "True if country is independent or permitted to start their own Diplomatic Plays  <br>aggressive_diplomatic_plays_permitted = boolTraits: yes/no   <br>**Supported Scopes**: country",
			...
			"approaching_bureaucracy_shortage": "Check if Institutions in the country will incur a Bureaucracy shortage eventuallyTraits: yes/no   <br>**Supported Scopes**: country",
			"arable_land": "Check arable land in state  <br>arable_land > 10Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: state",
			"arable_land_country": "Compare arable land in *all* states  <br>arable_land_country > 10Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"army_reserves": "Compare the amount of Army ReservesTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"assert_if": "Conditionally cause an assert during run time  <br>assert_if = { limit = { X } text = Y }, where X is a trigger and Y is an optional string  <br>**Supported Scopes**: none",
			"assert_read": "Conditionally cause an assert during read time  <br>assert_read = X, where X is yes or the string to be printed in the assert  <br>**Supported Scopes**: none",
			"authority": "Compares the available authority of the scoped countryTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"available_jobs": "Checks the state's number of available jobs in non-subsistence buildings  <br>available_jobs > 10000Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: state",
			"average_country_infrastructure": "Check average infrastructure in all states owned by scope country  <br>average_country_infrastructure = 3Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"average_incorporated_country_infrastructure": "Check average infrastructure in incorporated states owned by the scope country  <br>average_incorporated_country_infrastructure = 3Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"battle_side_pm_usage": "Checks how the ratio of Combat Units on the scoped Battle, on the target country's side, with the specified Production Method compares to the value  <br>battle_side_pm_usage = { target = X production_method = Y value <comparator> Z}  <br>where X = country scope and Y = production method key and Z = value to compare toTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: battle",
			"building_has_goods_shortage": "Check if building has a shortage of any of its inputs  <br>building_has_goods_shortage = yes/noTraits: yes/no   <br>**Supported Scopes**: building",
			"bureaucracy": "Compares the available bureaucracy of the scoped countryTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			...
			"can_be_enacted": "Checks if a law could be enacted by its country, considering its current situation  <br>can_be_enacted = yesTraits: yes/no   <br>**Supported Scopes**: law",
			...
			"can_start_tutorial_lesson": "Can the specified tutorial lesson be started?  <br>can_start_tutorial_lesson = reactive_advice_successionAn interface trigger, can only be used in specific places  <br>**Supported Scopes**: none",
			...
			"cash_reserves_available": "Evaluates a production building's available cash reserves  <br>cash_reserves_available > 25000Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: building",
			"cash_reserves_ratio": "Evaluates a production building's available cash reserve ratio compared to its maximum  <br>Returns 1 if the building has no maximum cash reserves  <br>cash_reserves_ratio > 0.2Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: building",
			"character_supports_political_movement": "Checks whether the scoped character supports a political movement  <br>character_supports_political_movement = yes/noTraits: yes/no   <br>**Supported Scopes**: character",
			...
			"civil_war_progress": "Compare progress of civil war  <br>civil_war_progress > 0.50Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: civil_war",
			"commander_is_available": "Check if a commander is not busy  <br>commander_is_available = boolTraits: yes/no   <br>**Supported Scopes**: character",
			"commander_pm_usage": "Checks how the ratio of Combat Units on the scoped Commander, on the target country's side, with the specified Production Method compares to the value  <br>commander_pm_usage = { target = X production_method = Y value <comparator> Z}  <br>where X = country scope and Y = production method key and Z = value to compare toTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: character",
			"commander_rank": "Compares the commanders rank  <br>commander_rank > 2Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: character",
			"construction_queue_duration": "Compares the maximum of all the very roughly approximated weeks remaining to finish the constructions in any queue: construction_queue_duration < 52Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"construction_queue_government_duration": "Compares the very roughly approximated weeks remaining to finish the constructions in the government queue: construction_queue_government_duration < 52Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"construction_queue_num_queued_government_levels": "Compares the number of government constructed building levels in the construction queueTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"construction_queue_num_queued_levels": "Compares the number of building levels in the construction queueTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"construction_queue_num_queued_private_levels": "Compares the number of privately constructed building levels in the construction queueTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"construction_queue_private_duration": "Compares the very roughly approximated weeks remaining to finish the constructions in the private queue: construction_queue_private_duration < 52Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			...
			"country_pm_usage": "Checks how the ratio of Combat Units (of the same type) on the scoped Country with the specified Production Method compares to the value  <br>country_pm_usage = { target = X production_method = Y value <comparator> Z}  <br>where X = country scope and Y = production method key and Z = value to compare toTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"country_rank": "Compares a Country's Power Ranking  <br>country_rank < rank_value:major_powerTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"country_tier": "Compare tier of country tag  <br>country_tier = x  <br>**Supported Scopes**: country",
			"culture_accepted": "Checks if pop's culture is accepted  <br>culture_accepted = boolTraits: yes/no   <br>**Supported Scopes**: pop",
			"culture_is_discriminated_in": "Checks if a culture is discriminated against within the scope country  <br>culture_is_discriminated_in = c:USATraits: country scope  <br>**Supported Scopes**: culture  <br>**Supported Targets**: country",
			...
			"current_tooltip_depth": "Returns the number of tooltips currently open on screenAn interface trigger, can only be used in specific places<br>Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: none",
			...
			"day_value": "Day valueTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: none",
			"daynight_value": "DayNight valueTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: none",
			...
			"devastation": "Compares the devastation of a given state  <br>devastation > 5Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: state",
			"diplomatic_play_pm_usage": "Checks how the ratio of Combat Units (of the same type) on the scoped Diplomatic Play, on the target country's side, with the specified Production Method compares to the value  <br>diplomatic_play_pm_usage = { target = X production_method = Y value <comparator> Z}  <br>where X = country scope and Y = production method key and Z = value to compare toTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: diplomatic_play",
			"earnings": "Compare a building's current annual earnings per employee  <br>earnings >= 10Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: building",
			"election_momentum": "Compare election momentum of the scoped party against a value  <br>election_momentum = 0.75Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: party",
			"empty_agitator_slots": "Checks number of empty agitator slots in a country  <br>empty_agitator_slots >= 1Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"enacting_any_law": "Checks if you're enacting any law.  <br>enacting_any_law = boolTraits: yes/no   <br>**Supported Scopes**: country",
			...
			"enactment_chance_without_enactment_modifier": "Compares the current enactment chance in scope country but excludes values from enactment modifierTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			...
			"escalation": "Checks whether escalation has passed a certain threshold  <br>escalation > -58Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: diplomatic_play",
			...
			"experience_level": "Compares the character experience level  <br>experience_level > 1Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: character",
			"free_arable_land": "Check free arable land in state  <br>free_arable_land > 0Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: state",
			"front_side_pm_usage": "Checks how the ratio of Combat Units on the scoped Front, on the target country's side, with the specified Production Method compares to the value  <br>front_side_pm_usage = { target = X production_method = Y value <comparator> Z}  <br>where X = country scope and Y = production method key and Z = value to compare toTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: front",
			"game_date": "Compare to current game date  <br>current_game_date = 1837.1.1Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: none",
			"global_country_ranking": "Compares a Country's Power Ranking (position)  <br>global_country_ranking > 42Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"global_population": "Compares the global population  <br>global_population > 2000000000Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: none",
			...
			"gold_reserves": "Does the country have the required gold reserves  <br>gold_reserves > 500Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"gold_reserves_limit": "Compares the country's gold reserves limit  <br>gold_reserves > gold_reserves_limitTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"government_legitimacy": "Compare LegitimacyTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"government_transfer_of_power": "Checks country's government's transfer of power  <br>government_transfer_of_power = keyTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			...
			"has_active_peace_deal": "True if the country is in a war where there is a proposed peace deal  <br>has_active_peace_deal = boolTraits: yes/no   <br>**Supported Scopes**: country",
			...
			"has_any_secessionists_broken_out": "Check if the country has secessionists broken outTraits: yes/no   <br>**Supported Scopes**: country",
			"has_any_secessionists_growing": "Check if the country has any secessionists growingTraits: yes/no   <br>**Supported Scopes**: country",
			"has_any_secessionists_possible": "Check if the country has any new secessionists possibleTraits: yes/no   <br>**Supported Scopes**: country",
			...
			"has_convoys_being_sunk": "Check if the country has convoys being sunk through convoy raidingTraits: yes/no   <br>**Supported Scopes**: country",
			"has_cosmetic_dlc": "Does the client have this cosmetic DLCAn interface trigger, can only be used in specific places  <br>**Supported Scopes**: none",
			...
			"has_decreasing_interests": "Checks if the country has decreasing interest levelsTraits: yes/no   <br>**Supported Scopes**: country",
			...
			"has_diplomatic_play": "Check if strategic region has a diplomatic play or notTraits: yes/no   <br>**Supported Scopes**: strategic_region",
			...
			"has_diplomats_expelled": "Checks if country in scope has recently expelled diplomats of event target  <br>has_diplomats_expelled = countryTraits: country scope  <br>**Supported Scopes**: country  <br>**Supported Targets**: country",
			...
			"has_failed_hires": "Checks if a building failed to hire someone last week  <br>has_failed_hires = yes/noTraits: yes/no   <br>**Supported Scopes**: building",
			...
			"has_game_started": "True if game has started  <br>has_game_started = boolTraits: yes/no   <br>**Supported Scopes**: none",
			"has_gameplay_dlc": "Does the host have this gameplay DLC  <br>**Supported Scopes**: none",
			"has_global_highest_gdp": "Checks if the scoped country has the highest GDP  <br>has_global_highest_gdp = yes/noTraits: yes/no   <br>**Supported Scopes**: country",
			"has_global_highest_innovation": "Checks if the scoped country has the highest weekly innovation  <br>has_global_highest_innovation = yes/noTraits: yes/no   <br>**Supported Scopes**: country",
			...
			"has_government_clout": "Does the country's government have the necessary total CloutTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"has_government_type": "Is the country's government type as specified  <br>has_government_type = key  <br>**Supported Scopes**: country",
			"has_healthy_economy": "Check if the country has a healthy economyTraits: yes/no   <br>**Supported Scopes**: country",
			"has_high_attrition": "Checks if a Commander's attrition is higher than defined NORMAL_ATTRITION  <br>has_high_attrition = boolTraits: yes/no   <br>**Supported Scopes**: character",
			...
			"has_insurrectionary_interest_groups": "Check if the country has Interest Groups that are insurrectionaryTraits: yes/no   <br>**Supported Scopes**: country",
			...
			"has_law": "Checks if a country has a certain Law activeTraits: law_type scope  <br>**Supported Scopes**: country  <br>**Supported Targets**: law_type",
			...
			"has_map_interaction": "Checks if the map interaction type is active  <br>has_map_interaction = keyAn interface trigger, can only be used in specific places  <br>**Supported Scopes**: none",
			"has_map_interaction_diplomatic_action": "Checks if our current map interaction is a specific diplomatic action  <br>has_map_interaction_diplomatic_action = <key>An interface trigger, can only be used in specific places  <br>**Supported Scopes**: none",
			"has_map_interaction_export_goods": "Checks if the specified lens option is to export the specified goods  <br>has_selected_export_option_for_goods = <scope>An interface trigger, can only be used in specific places  <br>**Supported Scopes**: none",
			"has_map_interaction_import_goods": "Checks if the specified lens option is to import the specified goods  <br>has_selected_import_option_for_goods = <scope>An interface trigger, can only be used in specific places  <br>**Supported Scopes**: none",
			...
			"has_ongoing_assimilation": "Checks if the scoped pop has ongoing cultural assimilation  <br>has_ongoing_assimilation = yesTraits: yes/no   <br>**Supported Scopes**: pop",
			"has_ongoing_conversion": "Checks if the scoped pop has ongoing religious conversion  <br>has_ongoing_conversion = yesTraits: yes/no   <br>**Supported Scopes**: pop",
			...
			"has_party": "True if IG scope has a party  <br>has_party = boolTraits: yes/no   <br>**Supported Scopes**: interest_group",
			...
			"has_port": "Check if state has at least one port  <br>has_port = yes/noTraits: yes/no   <br>**Supported Scopes**: country, market, state",
			"has_possible_decisions": "Check if a country has any possible Decisions  <br>has_possible_decisions = yesTraits: yes/no   <br>**Supported Scopes**: country",
			...
			"has_reached_end_date": "True if the end date (NDefines::NGame::END_DATE) has been reached  <br>has_reached_end_date = yesTraits: yes/no   <br>**Supported Scopes**: none",
			...
			"has_revolution": "Check if the country has revolutionary uprisingTraits: yes/no   <br>**Supported Scopes**: country",
			"has_revolution_over_law_type": "Checks if a country is having a revolution over a particular law type  <br>has_revolution_over_law_type = law_type:law_autocracyTraits: law_type scope  <br>**Supported Scopes**: country  <br>**Supported Targets**: law_type",
			...
			"has_ruling_interest_group_count": "Does the country's government consist of the specified number of IGsTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			...
			"has_state_religion": "Check if the Pop has the state religionTraits: yes/no   <br>**Supported Scopes**: pop",
			...
			"has_subject_relation_with": "Checks if country in scope is subject or overlord of event target  <br>has_subject_relation_with = countryTraits: country scope  <br>**Supported Scopes**: country  <br>**Supported Targets**: country",
			...
			"has_technology_progress": "Does the country have the required progress for an technology  <br>has_technology_progress = { technology = X progress = Y }  <br>Where X is an technology and Y is a fixed pointTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			...
			"has_truce_with": "Check if a country has a truce with a different target country  <br>has_truce_with = c:GBRTraits: country scope  <br>**Supported Scopes**: country  <br>**Supported Targets**: country",
			...
			"has_war_with": "Checks if country in scope is at war with event target  <br>has_war_with = countryTraits: country scope  <br>**Supported Scopes**: country  <br>**Supported Targets**: country",
			...
			"highest_secession_progress": "Compares the highest secession progress of any secession movement in a given country  <br>highest_secession_progress > 0.7Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"ig_approval": "Compare to scoped interest group approval  <br>Usages: ig_approval > 2, ig_approval < happyTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: interest_group",
			"ig_clout": "Compare to scoped interest group's clout  <br>ig_clout >= 0.2Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: interest_group",
			"ig_government_power_share": "Compare to scoped interest group's political strength divided by total government political strength  <br>ig_government_power_share >= 0.5Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: interest_group",
			...
			"in_default": "Check if the country is currently in defaultTraits: yes/no   <br>**Supported Scopes**: country",
			...
			"incorporation_progress": "Check incorporation progress in state  <br>incorporation_progress > 0.25Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: state",
			"influence": "Compares the available influence of the scoped countryTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"infrastructure": "Compares the infrastructure value of a given state  <br>infrastructure > 10Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: state, state_region",
			"infrastructure_usage": "Compares the infrastructure usage value of a given state  <br>infrastructure_usage > 10Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: state, state_region",
			"initiator_is": "Checks who the initiator of a diplomatic play is  <br>initiator_is = countryTraits: country scope  <br>**Supported Scopes**: diplomatic_play  <br>**Supported Targets**: country",
			...
			"interest_group_population": "Compares population number in an interest group  <br>interest_group_population > 1000Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: interest_group",
			"interest_group_population_percentage": "Compares percentage of population in an interest group  <br>interest_group_population_percentage > 0.2Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: interest_group",
			"interest_group_supports_political_movement": "Checks whether the scoped interest group supports a political movement  <br>interest_group_supports_political_movement = yes/noTraits: yes/no   <br>**Supported Scopes**: interest_group",
			"investment_pool": "Does the country have this amount of money saved in its investment pool  <br>investment_pool > 1000Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"investment_pool_gross_income": "Does the country have this amount of gross income (income before expenses) for its investment pool  <br>investment_pool_gross_income > 1000Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"investment_pool_net_income": "Does the country have this amount of net income (income after expenses) for its investment pool  <br>investment_pool_net_income > 1000Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"is_adjacent": "Checks if country in scope is adjacent to a target country  <br>is_adjacent = <scope>Traits: country scope  <br>**Supported Scopes**: country  <br>**Supported Targets**: country",
			"is_advancing_on_front": "Checks if a commander is advancing on a front  <br>is_advancing_on_front = frontTraits: front scope  <br>**Supported Scopes**: character  <br>**Supported Targets**: front",
			"is_ai": "True if country scope is controlled by an AI  <br>is_ai = boolTraits: yes/no   <br>**Supported Scopes**: country",
			"is_at_war": "Check if the country is at warTraits: yes/no   <br>**Supported Scopes**: country",
			"is_attacker_in_battle": "Checks if a Commander is attacker in a battle  <br>is_attacker_in_battle = boolTraits: yes/no   <br>**Supported Scopes**: character",
			...
			"is_buildable": "Check if a building is buildable = yes (default)  <br>is_buildable = yes/noTraits: yes/no   <br>**Supported Scopes**: building",
			...
			"is_building_type_expanded": "Checks if the CProductionMethodsPanelEntry for a particular CBuildingType is expanded  <br>is_building_type_expanded = <scope/key>An interface trigger, can only be used in specific places  <br>**Supported Scopes**: none",
			"is_busy": "Check if character is busy  <br>is_busy = boolTraits: yes/no   <br>**Supported Scopes**: character",
			"is_capital": "Check if state is the capital of the owner = boolTraits: yes/no   <br>**Supported Scopes**: state",
			"is_character_alive": "Checks if the scoped character is alive  <br>is_character_alive = boolTraits: yes/no   <br>**Supported Scopes**: character",
			...
			"is_coastal": "Check if state borders a (non-impassable) sea region  <br>is_coastal = yes/noTraits: yes/no   <br>**Supported Scopes**: state",
			"is_construction_paused": "Check if construction in a state is paused.Traits: yes/no   <br>**Supported Scopes**: country",
			"is_consumed_by_government_buildings": "Check if the market goods is instrumental in running the bureaucratic machineTraits: yes/no   <br>**Supported Scopes**: market_goods",
			"is_consumed_by_military_buildings": "Check if the goods is instrumental in running the war machineTraits: yes/no   <br>**Supported Scopes**: market_goods",
			"is_country_alive": "Checks if the scoped country is alive, i.e. if it has at least one state on the map and can be interacted with  <br>is_country_alive = yes/noTraits: yes/no   <br>**Supported Scopes**: country",
			"is_country_type": "Checks the countrys type  <br>is_country_type = country type  <br>**Supported Scopes**: country",
			"is_defender_in_battle": "Checks if a Commander is defender in a battle  <br>is_defender_in_battle = boolTraits: yes/no   <br>**Supported Scopes**: character",
			...
			"is_diplomatic_pact_in_danger": "Checks if diplomatic pact is in danger of breaking  <br>is_diplomatic_pact_in_danger = yesTraits: yes/no   <br>**Supported Scopes**: diplomatic_pact",
			"is_diplomatic_play_committed_participant": "True if country is a committed participant of any diplomatic play  <br>is_diplomatic_play_participant = boolTraits: yes/no   <br>**Supported Scopes**: country",
			"is_diplomatic_play_enemy_of": "Checks if country in scope is in a diplomatic play against event target  <br>is_diplomatic_play_enemy_of = countryTraits: country scope  <br>**Supported Scopes**: country  <br>**Supported Targets**: country",
			"is_diplomatic_play_initiator": "True if country is the initiator of any diplomatic play  <br>is_diplomatic_play_initiator = boolTraits: yes/no   <br>**Supported Scopes**: country",
			"is_diplomatic_play_target": "True if country is the target of any diplomatic play  <br>is_diplomatic_play_target = boolTraits: yes/no   <br>**Supported Scopes**: country",
			...
			"is_diplomatic_play_undecided_participant": "True if country is a undecided participant of any diplomatic play  <br>is_diplomatic_play_participant = boolTraits: yes/no   <br>**Supported Scopes**: country",
			"is_direct_subject_of": "Checks if country in scope is a direct subject (not subject-of-subject) of event target  <br>is_subject_of = countryTraits: country scope  <br>**Supported Scopes**: country  <br>**Supported Targets**: country",
			"is_employed": "Check if the pop is employedTraits: yes/no   <br>**Supported Scopes**: pop",
			"is_enacting_law": "Checks if the scoped country is enacting a specific law type.  <br>is_enacting_law = law_type:law_conscriptionTraits: law_type scope  <br>**Supported Scopes**: country  <br>**Supported Targets**: law_type",
			...
			"is_female": "Check if character is female  <br>is_female = boolTraits: yes/no   <br>**Supported Scopes**: character",
			"is_game_paused": "Checks if the game is paused  <br>is_game_paused = yes/noAn interface trigger, can only be used in specific places<br>Traits: yes/no   <br>**Supported Scopes**: none",
			"is_gamestate_tutorial_active": "Is the gamestate tutorial active? See save_progress_in_gamestate in tutorial_lesson_chains documentation.An interface trigger, can only be used in specific places<br>Traits: yes/no   <br>**Supported Scopes**: none",
			"is_goal_complete": "Check if the journal entry's goal has been met  <br>is_goal_complete = yes/noTraits: yes/no   <br>**Supported Scopes**: journalentry",
			"is_government_funded": "Check if a building is is_government_funded  <br>is_government_funded = yes/noTraits: yes/no   <br>**Supported Scopes**: building",
			"is_heir": "Checks whether the scoped character is an heir  <br>is_heir = yes / noTraits: yes/no   <br>**Supported Scopes**: character",
			"is_historical": "Check if character is historical  <br>is_historical = yes/noTraits: yes/no   <br>**Supported Scopes**: character",
			"is_home_country_for": "Checks if a country is the home country for target countryTraits: country scope  <br>**Supported Scopes**: country  <br>**Supported Targets**: country",
			...
			"is_in_battle": "Checks if a Commander is engaged in battle  <br>is_in_battle = boolTraits: yes/no   <br>**Supported Scopes**: character",
			"is_in_customs_union": "Check if the country is part of a customs unionTraits: yes/no   <br>**Supported Scopes**: country",
			"is_in_exile_pool": "Checks whether the scoped character is in the exile pool  <br>is_in_exile_pool = yes/noTraits: yes/no   <br>**Supported Scopes**: character",
			"is_in_government": "True if IG scope is in the government  <br>is_in_government = boolTraits: yes/no   <br>**Supported Scopes**: interest_group",
			...
			"is_in_void": "Check if character is in the void  <br>is_in_void = boolTraits: yes/no   <br>**Supported Scopes**: character",
			"is_in_war_together": "Checks if country in scope is in war on the same side as event target  <br>is_in_war_together = countryTraits: country scope  <br>**Supported Scopes**: country  <br>**Supported Targets**: country",
			"is_incorporated": "Check if state is incorporated = boolTraits: yes/no   <br>**Supported Scopes**: state",
			"is_insurrectionary": "True if IG scope is contributing to a brewing revolution  <br>is_insurrectionary = boolTraits: yes/no   <br>**Supported Scopes**: interest_group",
			"is_interest_active": "Is the interest marker active  <br>is_interest_active = yes/noTraits: yes/no   <br>**Supported Scopes**: interest_marker",
			...
			"is_isolated_from_market": "Check if a state is isolated from its marketTraits: yes/no   <br>**Supported Scopes**: state",
			"is_junior_in_customs_union": "True if country is a junior country in a customs custom  <br>is_junior_in_customs_union = boolTraits: yes/no   <br>**Supported Scopes**: country",
			"is_land_theater": "Checks if a theater is a land theater  <br>is_land_theater = boolTraits: yes/no   <br>**Supported Scopes**: theater",
			"is_largest_state_in_region": "Check if state is the largest in the state region = boolTraits: yes/no   <br>**Supported Scopes**: state",
			"is_lens_open": "Checks if a certain lens is open, specified as a lens key. Specify an optional named tab to check if this tab is open.  <br>is_lens_open = { lens = lens_key tab_name = tab_key }An interface trigger, can only be used in specific places  <br>**Supported Scopes**: none",
			"is_local_player": "True if country scope is a player  <br>is_local_player = boolTraits: yes/no   <br>**Supported Scopes**: country",
			"is_losing_power_rank": "Check if the country is in the process of dropping in power rankingTraits: yes/no   <br>**Supported Scopes**: country",
			"is_marginal": "True if IG scope is marginal  <br>is_marginal = boolTraits: yes/no   <br>**Supported Scopes**: interest_group",
			...
			"is_mobilized": "Checks if the commander is mobilized  <br>is_mobilized = boolTraits: yes/no   <br>**Supported Scopes**: character",
			"is_monarch": "Checks if character is a monarch of a country with hereditary succession  <br>is_monarch = boolTraits: yes/no   <br>**Supported Scopes**: character",
			"is_objective_completed": "Is the objective completed for the country in scope?  <br>is_objective_completed = yesTraits: yes/no   <br>**Supported Scopes**: none",
			"is_on_front": "Checks is a character has been assigned to a Front and has arrived there  <br>is_on_front = yes/noTraits: yes/no   <br>**Supported Scopes**: character",
			"is_owed_obligation_by": "Checks if the scoped country is owed a obligation by the target country  <br>is_owed_obligation_by = c:FRATraits: country scope  <br>**Supported Scopes**: country  <br>**Supported Targets**: country",
			"is_panel_open": "Checks if a certain infopanel is open, specified as an event target (target) or as a string (panel_name). Specify an optional named tab (tab_name) to check if this tab is open.  <br>is_panel_open = { target = <scope> OR panel_name = panel_name tab_name = tab_name }An interface trigger, can only be used in specific places  <br>**Supported Scopes**: none",
			...
			"is_player": "True if country scope is a player  <br>is_player = boolTraits: yes/no   <br>**Supported Scopes**: country",
			...
			"is_popup_open": "Checks if the specified popup panel is open  <br>is_popup_open = popupAn interface trigger, can only be used in specific places  <br>**Supported Scopes**: none",
			"is_powerful": "True if IG scope is influential  <br>is_powerful = boolTraits: yes/no   <br>**Supported Scopes**: interest_group",
			...
			"is_progressing": "Check if the journal entry is progressing  <br>is_progressing = yes/noTraits: yes/no   <br>**Supported Scopes**: journalentry",
			"is_province_land": "Check if the province is on landTraits: yes/no   <br>**Supported Scopes**: province",
			"is_repairing": "Checks if an Admiral is unavailable and repairing after loosing a naval battle  <br>is_repairing = boolTraits: yes/no   <br>**Supported Scopes**: character",
			...
			"is_revolutionary": "Check if the country is revolutionaryTraits: yes/no   <br>**Supported Scopes**: country, interest_group",
			"is_revolutionary_movement": "Check whether the scoped political movement is causing a brewing revolution in the country  <br>is_revolutionary_movement = yes/noTraits: yes/no   <br>**Supported Scopes**: political_movement",
			"is_rightclick_menu_open": "Checks if the specified rightclick menu is open  <br>is_rightclick_menu_open = <menu_key>An interface trigger, can only be used in specific places  <br>**Supported Scopes**: none",
			"is_ruler": "Checks if character is a ruler/head of state of a country  <br>is_ruler = boolTraits: yes/no   <br>**Supported Scopes**: character",
			"is_same_interest_group_type": "Checks if Interest Group is of the same IG type as target  <br>is_interest_group_type = scope:neighbor_leading_igTraits: interest_group scope  <br>**Supported Scopes**: interest_group  <br>**Supported Targets**: interest_group",
			...
			"is_same_party_type": "Checks if Party is of the same party type as target  <br>is_same_party_type_as = scope:neighboring_partyTraits: party scope  <br>**Supported Scopes**: party  <br>**Supported Targets**: party",
			"is_sea_adjacent": "Check if state borders a sea region (regular or impassable)  <br>is_sea_adjacent = yes/noTraits: yes/no   <br>**Supported Scopes**: state",
			"is_secessionist": "Check if the country is secessionistTraits: yes/no   <br>**Supported Scopes**: country",
			...
			"is_state_region_land": "Check if the state region is on landTraits: yes/no   <br>**Supported Scopes**: state_region",
			...
			"is_strongest_ig_in_government": "Checks whether the scoped interest group has the most clout out of all interest groups in government  <br>is_strongest_ig_in_government = yes/noTraits: yes/no   <br>**Supported Scopes**: interest_group",
			"is_subject": "True if country is a subject  <br>is_subject = boolTraits: yes/no   <br>**Supported Scopes**: country",
			"is_subject_of": "Checks if country in scope is subject (or subject-of-subject) of event target  <br>is_subject_of = countryTraits: country scope  <br>**Supported Scopes**: country  <br>**Supported Targets**: country",
			"is_subject_type": "Checks the country's subject type  <br>is_subject_type = subject type  <br>**Supported Scopes**: country",
			"is_subsidized": "Check if a building is being subsidized  <br>is_subsidized = yes/noTraits: yes/no   <br>**Supported Scopes**: building",
			"is_subsistence_building": "Check if a building is a subsistence building  <br>is_subsistence_building = yes/noTraits: yes/no   <br>**Supported Scopes**: building",
			...
			"is_trade_route_active": "Checks if the scoped trade route is active  <br>is_trade_route_active = yes/noTraits: yes/no   <br>**Supported Scopes**: trade_route",
			"is_trade_route_productive": "Checks if the scoped trade route is productive  <br>is_trade_route_productive = yes/noTraits: yes/no   <br>**Supported Scopes**: trade_route",
			"is_tradeable": "Check if a goods or market goods is tradeable  <br>is_tradeable = yes/noTraits: yes/no   <br>**Supported Scopes**: goods, market_goods",
			"is_traveling": "Checks if the commander is traveling  <br>is_traveling = boolTraits: yes/no   <br>**Supported Scopes**: character",
			"is_treaty_port": "Checks if the scoped state is a treaty port  <br>is_treaty_port = yes/noTraits: yes/no   <br>**Supported Scopes**: state",
			"is_tutorial_active": "Is the tutorial active?An interface trigger, can only be used in specific places<br>Traits: yes/no   <br>**Supported Scopes**: none",
			"is_tutorial_lesson_active": "Is this the current tutorial lesson?  <br>is_tutorial_lesson_active = reactive_advice_successionAn interface trigger, can only be used in specific places  <br>**Supported Scopes**: none",
			"is_tutorial_lesson_chain_completed": "Has the tutorial lesson chain with the specified key been finished?An interface trigger, can only be used in specific places  <br>**Supported Scopes**: none",
			"is_tutorial_lesson_completed": "has the tutorial lesson with the specified name been finished?An interface trigger, can only be used in specific places  <br>**Supported Scopes**: none",
			"is_tutorial_lesson_step_completed": "Has the tutorial lesson step been finished?  <br>is_tutorial_lesson_step_completed = lesson_key:step_keyAn interface trigger, can only be used in specific places  <br>**Supported Scopes**: none",
			"is_under_colonization": "Check if state is under colonization  <br>is_under_colonization = yes/noTraits: yes/no   <br>**Supported Scopes**: state",
			"is_under_construction": "Checks if building is under construction  <br>is_under_construction = boolTraits: yes/no   <br>**Supported Scopes**: building",
			...
			"is_violating_sovereignty_of": "Check if the scoped country is violating the sovereignty of a target country  <br>is_violating_sovereignty_of = c:GBRTraits: country scope  <br>**Supported Scopes**: country  <br>**Supported Targets**: country",
			"is_vulnerable_front": "Whether the scoped Front doesn't have any Battalions nor Generals on target side, and the enemy has at least one General.  <br>is_vulnerable_front = scope:example_countryTraits: country scope  <br>**Supported Scopes**: front  <br>**Supported Targets**: country",
			"is_war": "True if the diplomatic play has escalated into war  <br>is_war = boolTraits: yes/no   <br>**Supported Scopes**: diplomatic_play",
			"is_war_participant": "Check if the target country is participant in a warTraits: country scope  <br>**Supported Scopes**: war  <br>**Supported Targets**: country",
			"is_warleader": "Check if country is warleader in warTraits: country scope  <br>**Supported Scopes**: war  <br>**Supported Targets**: country",
			"isolated_states": "Compare number of Isolated StatesTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			...
			"leading_producer_of": "Checks if country is producing the most of a certain good  <br>leading_producer_of = g:luxury_clothesTraits: goods scope  <br>**Supported Scopes**: country  <br>**Supported Targets**: goods",
			"leads_customs_union": "Check if any other country is part of this country's customs union  <br>leads_customs_union = boolTraits: yes/no   <br>**Supported Scopes**: country",
			"list_size": "Checks the size of a list  <br>list_size = { name = X value >= Y }  <br>Where X is the name of the list  <br>Where Y is a script valueTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: none",
			"literacy_rate": "Checks if a pop, state or country has a certain amount of literacy  <br>literacy = valueTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country, pop, state",
			...
			"loyalty": "Compares the loyalty in a given state, i.e. the fraction of Loyalists  <br>loyalty > 0.2Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: state",
			"market_access": "Checks the market access of the scoped state  <br>market_access > 0.8Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: state",
			"market_goods_buy_orders": "Checks if market goods has the specified number of buy orders  <br>market_goods_buy_orders < X  <br>Where X = fixed pointTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: market_goods",
			"market_goods_cheaper": "Checks if market goods is at least the specified percentage cheaper than base price  <br>market_goods_cheaper > X  <br>Where X = fixed pointTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: market_goods",
			"market_goods_consumption": "Checks if market goods has the specified number of total consumption  <br>market_goods_consumption < X  <br>Where X = fixed pointTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: market_goods",
			"market_goods_delta": "Checks if market has the specified goods delta (production + imports) - (consumption + exports)  <br>market_goods_delta < X  <br>Where X = fixed pointTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: market_goods",
			"market_goods_exports": "Checks if market goods has the specified number of exports  <br>market_goods_exports < X  <br>Where X = fixed pointTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: market_goods",
			"market_goods_has_goods_shortage": "Check if market goods has a shortage in the market  <br>market_goods_has_goods_shortage = yes/noTraits: yes/no   <br>**Supported Scopes**: market_goods",
			"market_goods_imports": "Checks if market goods has the specified number of imports  <br>market_goods_imports < X  <br>Where X = fixed pointTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: market_goods",
			"market_goods_pricier": "Checks if market goods is at least the specified percentage more expensive than base price  <br>market_goods_pricier > X  <br>Where X = fixed pointTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: market_goods",
			"market_goods_production": "Checks if market goods has the specified number of total production  <br>market_goods_production < X  <br>Where X = fixed pointTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: market_goods",
			"market_goods_sell_orders": "Checks if market goods has the specified number of sell orders  <br>market_goods_sell_orders < X  <br>Where X = fixed pointTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: market_goods",
			"market_goods_shortage_ratio": "Compares the shortage ratio of a market goods in its market  <br>market_goods_shortage_ratio > 0.33Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: market_goods",
			"market_has_goods_shortage": "Check if market has a shortage on any of its building inputs  <br>market_has_goods_shortage = yes/noTraits: yes/no   <br>**Supported Scopes**: market",
			...
			"mobilization_cost": "Compares the current mobilization cost for this character  <br>mobilization_cost > 1000Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: character",
			"month": "Compare to current game date month (Jan: 0, Dec: 11)  <br>month > 10Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: none",
			...
			"nand": "a negated AND trigger  <br>**Supported Scopes**: none",
			"navy_reserves": "Compare the amount of Navy ReservesTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"night_value": "Night valueTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: none",
			"nor": "a negated OR trigger  <br>**Supported Scopes**: none",
			"not": "negates content of trigger  <br>**Supported Scopes**: none",
			"num_casualties": "Checks the number of total casualties in the scoped war  <br>num_casualties >= 5000Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: war",
			"num_country_casualties": "checks the number of casualties for a specific country in the scoped war  <br>num_country_casualties = { target = country value < 5000 }Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: war",
			"num_country_dead": "checks the number of dead for a specific country in the scoped war  <br>num_country_dead = { target = country value < 5000 }Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: war",
			"num_country_wounded": "checks the number of wounded for a specific country in the scoped war  <br>num_country_wounded = { target = country value < 5000 }Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: war",
			"num_dead": "Checks the number of total dead in the scoped war  <br>num_dead >= 5000Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: war",
			...
			"num_wounded": "Checks the number of total wounded in the scoped war  <br>num_wounded >= 5000Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: war",
			"number_of_possible_decisions": "The number of possible Descision a Country can take  <br>umber_of_possible_decisions > 0Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"occupancy": "Evaluates a building's current occupancy  <br>occupancy < 0.25Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: building",
			"or": "at least one entry inside trigger must be true  <br>**Supported Scopes**: none",
			"owes_obligation_to": "Checks if country in scope owes a obligation to event target  <br>owes_obligation_to = countryTraits: country scope  <br>**Supported Scopes**: country  <br>**Supported Targets**: country",
			...
			"political_movement_radicalism": "Compare radicalism of political movement  <br>political_movement_radicalism > 50Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: political_movement",
			"political_movement_support": "Compare support of political movement  <br>political_movement_support > 50Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: political_movement",
			"pollution_amount": "Compare state region pollutionTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: state_region",
			"pollution_generation": "Compare total pollution generation across all buildings in the stateTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: state",
			...
			"pop_has_primary_culture": "Checks if pop's culture is primary  <br>pop_has_primary_culture = boolTraits: yes/no   <br>**Supported Scopes**: pop",
			"pop_is_discriminated": "Checks if pop is discriminated against  <br>pop_is_discriminated = boolTraits: yes/no   <br>**Supported Scopes**: pop",
			...
			"prestige": "Compare prestigeTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"produced_authority": "Compares the produced authority of the scoped countryTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"produced_bureaucracy": "Compares the produced bureaucracy of the scoped countryTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"produced_influence": "Compares the produced influence of the scoped countryTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"quality_of_life": "Compares the quality of life of the given pop  <br>quality_of_life > 10Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: pop",
			...
			"relative_infrastructure": "Compares the infrastructure to infrastructure usage of a state  <br>relative_infrastructure > 1.1Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: state",
			"religion_accepted": "Checks if pop's religion is accepted  <br>religion_accepted = boolTraits: yes/no   <br>**Supported Scopes**: pop",
			...
			"ruler_can_have_command": "Checks if the country's government type allows its ruler to have command  <br>ruler_can_have_command = yes/noTraits: yes/no   <br>**Supported Scopes**: country",
			"save_temporary_scope_as": "Saves a temporary target for use during the trigger execution  <br>**Supported Scopes**: none",
			"save_temporary_scope_value_as": "Saves a numerical or bool value as an arbitrarily-named temporary target to be referenced later in the same effect  <br>save_temporary_scope_value_as = { name = <string> value = x }  <br>**Supported Scopes**: none",
			"scaled_debt": "Compare value to a country's debt relative to debt ceiling  <br>scaled_debt = valueTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			...
			"should_set_wargoal": "Check if the country is lacking a primary wargoal in any diplomatic play it is part ofTraits: yes/no   <br>**Supported Scopes**: country",
			"should_show_nudity": "can nudity be shown?  <br>should_show_nudity = yes/noAn interface trigger, can only be used in specific places<br>Traits: yes/no   <br>**Supported Scopes**: none",
			...
			"standard_of_living": "Compares the standard of living of a given pop  <br>standard_of_living > 10Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: pop",
			"state_has_goods_shortage": "Check if state has a shortage on any of its building inputs  <br>state_has_goods_shortage = yes/noTraits: yes/no   <br>**Supported Scopes**: state",
			"state_population": "Checks the total population of the scoped state  <br>state_population <= 250000Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: state",
			"state_unemployment_rate": "Checks the unemployment rate (percentage) in the scoped state  <br>state_unemployment_rate > 0.1Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: state",
			"strata": "Checks the strata of the scoped pop  <br>strata >= rich/middle/poorTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: pop",
			"supply_network_strength": "Compares the country's supply network strength (can exceed 1)  <br>supply_network_strength > 1.1Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			...
			"taking_loans": "Check if the country is currently running a weekly deficit and taking loans to compensateTraits: yes/no   <br>**Supported Scopes**: country",
			"target_is": "Checks who the target of a diplomatic play is  <br>target_is = countryTraits: country scope  <br>**Supported Scopes**: diplomatic_play  <br>**Supported Targets**: country",
			"tax_capacity": "Checks the taxation capacity of the scoped state  <br>tax_capacity > 50Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: state",
			"tax_capacity_usage": "Checks the taxation capacity usage of the scoped state  <br>tax_capacity_usage > 50Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: state",
			...
			"total_population": "Compares the total population of a given country  <br>total_population > 100000Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"total_population_including_subjects": "Compares the total population in the scope country and its subjects  <br>total_population_including_subjects > 40000000Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"total_population_including_subjects_share": "Compares the total population in the scope country and its subjects' share of the global population  <br>total_population_including_subjects_share > 0.4Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"total_population_share": "Compares the total population of a given country's share of the global population  <br>total_population_share > 0.02Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"total_urbanization": "Compares the total urbanization of a given state/ntotal_urbanization > 5Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: state",
			"trade_route_needs_convoys_to_grow": "Checks if the scoped trade route needs more convoys to be able to grow  <br>trade_route_needs_convoys_to_grow = yes/noTraits: yes/no   <br>**Supported Scopes**: trade_route",
			"trait_value": "Compares the character's total trait value  <br>trait_value < experience_levelTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: character",
			...
			"turmoil": "Compares the turmoil in a given state, i.e. the fraction of Radicals  <br>turmoil > 0.2Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: state",
			...
			"war_has_active_peace_deal": "True if the war has a proposed peace deal  <br>war_has_active_peace_deal = boolTraits: yes/no   <br>**Supported Scopes**: war",
			"was_exiled": "Checks whether the scoped character was exiled  <br>was_exiled = yes/noTraits: yes/no   <br>**Supported Scopes**: character",
			...
			"wealth": "Checks if a pop has a certain amount of wealth  <br>wealth = valueTraits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: pop",
			"weekly_net_fixed_income": "Does the country have this amount of weekly income after fixed expenses  <br>weekly_net_income > 1000Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: country",
			"weekly_profit": "Checks whether the profits the building has made this week are above or below a given value  <br>weekly_profit >= 20.0Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: building",
			...
			"year": "Compares the current year of the game  <br>year > 1850Traits: &lt;, &le;, =, !=, &gt;, &ge;  <br>**Supported Scopes**: none",
		}
		self.ScopesList = {
